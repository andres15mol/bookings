...
import (
	...
	"github.com/andres15mol/bookings/internal/repository/dbrepo"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	newReservationID, err := m.DB.InsertResevation(reservation)
...
// AdminAllReservations shows all reservstion in admin tool
...
func (m *Repository) AdminReservationCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		//get all the resetrivctions for the current rooms
...
func (m *Repository) AdminPostReservationCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// that does no exist in our posted data, and if the restriction id > 0, then it is a block we need to 
		//remove.
