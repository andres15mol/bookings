...
func (m *postgresDBRepo) InsertResevation(res models.Reservation) (int, error) {
...
//UpdatedProcessedForReservation updates proceese dor a reservation by id
...
//GetRestrictionsForRoomByDate retrun a restrictions for a room by date range
